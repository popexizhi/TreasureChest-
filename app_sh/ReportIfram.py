...
<body style="font-family: Arial, Helvetica, sans-serif;
    ...
    <div style=" box-shadow:0px 4px 4px rgba(0,0,0,0.12); padding:10px;">
      <h3>App Provision Load Test </h3>
        <h4 style="color:#666">http://192.168.1.43:18080/eap</h4>
        <h4 style="color:#666">http://192.168.1.43:18080/nap</h4>
        </div>
        <div style="padding:10px;">
          <h4> proxy_app_des: %s<br>
              %s </h4>
                <p>app provision 测试结果概述</p>
...
def get_iframe_br(htmlrp_des_list):
    """iframe 中详细的测试报告连接 """
    res = """<iframe id="iframe" src="%s" height="800" width="1800" frameborder="0" scrolling="no">%s</iframe><br>\n"""
    com = ""
